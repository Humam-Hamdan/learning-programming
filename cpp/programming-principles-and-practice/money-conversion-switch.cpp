...
int main()
{
	...
	constexpr double usd_to_chf = 0.8002924228;
	double amount = 0;
		...
		case jpy:
			...
			switch(unit_out){
				...
				case gbp:
					...
					break;
				case chf:
					cout << amount << " JPY = " << amount_curr * usd_to_chf << " CHF\n";
					break;
				case usd:
		...
		case nok:
			...
			switch(unit_out){ 
				...
				case gbp:
					...
					break;
				case chf:
					cout << amount << " NOK = " << amount_curr * usd_to_chf << " CHF\n";
					break;
				case usd:
		...
		case gbp:
			switch(unit_out){ 
				...
				case jpy:
					...
					break;
				case chf:
					cout << amount << " GBP = " << amount_curr * usd_to_chf << " CHF\n";
					break;
				case usd:
		...
		case usd:
			switch(unit_out){ 
				...
				case jpy:
					...
					break;
				case chf:
					cout << amount << " USD = " << amount_curr * usd_to_chf << " CHf\n";
					break;
				default :
					cout << "IDK!\n"; 
					break;
			...
			break;
		case chf:
			amount_curr = amount / usd_to_chf;
			switch(unit_out){
				case nok:
					cout << amount << " CHF = " << amount_curr * usd_to_nok << " NOK\n";
					break;
				case gbp:
					cout << amount << " CHF = " << amount_curr * usd_to_gbp << " GBP\n";
					break;
				case jpy:
					cout << amount << " CHF = " << amount_curr * usd_to_jpy << " JPY\n";
					break;
				case usd:
					cout << amount << " CHF = " << amount_curr << " USD\n";
					break;
				default : cout << "IDK!\n"; 
			}
			break;
